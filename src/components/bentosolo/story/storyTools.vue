<template>
  ...
  <story-modal v-show="storyspaceStatus.active === true" @close="closeModal">
    <template v-slot:header>
    </template>
    <template v-slot:storyspace>
...
<script>
import StoryModal from '@/components/bentosolo/story/storyModal.vue'
import StoryBuildstage from '@/components/bentosolo/story/buildStage.vue'
import StoryStage from '@/components/bentosolo/story/viewStage.vue'
