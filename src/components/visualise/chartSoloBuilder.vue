...
<script>
import CalendarTool from '@/components/visualise/tools/calendarTool.vue'
import OpendataTool from '@/components/visualise/tools/knowledgeLive.vue'
import hsvisual from '@/components/visualise/soloVisualise.vue'
  ...
  computed: {
    ...
    liveData: function () {
      ...
      if (!this.$store.state.solopositionSpace.soloData) {
        ...
        return this.$store.state.solopositionSpace.soloData[this.moduleCNRL].data[this.mData]
      }
    },
